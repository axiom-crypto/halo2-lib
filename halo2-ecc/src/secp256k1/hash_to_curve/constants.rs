...
pub(crate) fn get_Z<F: BigPrimeField>(
    ...
    let z = z.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, z.as_slice(), 64)
}
...
pub(crate) fn get_A<F: BigPrimeField>(
    ...
    let a = a.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, a.as_slice(), 64)
}
...
pub(crate) fn get_B<F: BigPrimeField>(
    ...
    let b = [1771, 0, 0, 0];
    let b = b.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, b.as_slice(), 64)
}
...
pub(crate) fn get_C1<F: BigPrimeField>(
    ...
    let c1 = c1.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, c1.as_slice(), 64)
}
...
pub(crate) fn get_C2<F: BigPrimeField>(
    ...
    let c2 = c2.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, c2.as_slice(), 64)
}
...
pub(crate) fn get_k_1_0<F: BigPrimeField>(
    ...
    let k_1_0 = k_1_0.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_1_0.as_slice(), 64)
}
...
pub(crate) fn get_k_1_1<F: BigPrimeField>(
    ...
    let k_1_1 = k_1_1.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_1_1.as_slice(), 64)
}
...
pub(crate) fn get_k_1_2<F: BigPrimeField>(
    ...
    let k_1_2 = k_1_2.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_1_2.as_slice(), 64)
}
...
pub(crate) fn get_k_1_3<F: BigPrimeField>(
    ...
    let k_1_3 = k_1_3.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_1_3.as_slice(), 64)
}
...
pub(crate) fn get_k_2_0<F: BigPrimeField>(
    ...
    let k_2_0 = k_2_0.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_2_0.as_slice(), 64)
}
...
pub(crate) fn get_k_2_1<F: BigPrimeField>(
    ...
    let k_2_1 = k_2_1.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_2_1.as_slice(), 64)
}
...
pub(crate) fn get_k_3_0<F: BigPrimeField>(
    ...
    let k_3_0 = k_3_0.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_3_0.as_slice(), 64)
}
...
pub(crate) fn get_k_3_1<F: BigPrimeField>(
    ...
    let k_3_1 = k_3_1.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_3_1.as_slice(), 64)
}
...
pub(crate) fn get_k_3_2<F: BigPrimeField>(
    ...
    let k_3_2 = k_3_2.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_3_2.as_slice(), 64)
}
...
pub(crate) fn get_k_3_3<F: BigPrimeField>(
    ...
    let k_3_3 = k_3_3.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_3_3.as_slice(), 64)
}
...
pub(crate) fn get_k_4_0<F: BigPrimeField>(
    ...
    let k_4_0 = k_4_0.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_4_0.as_slice(), 64)
}
...
pub(crate) fn get_k_4_1<F: BigPrimeField>(
    ...
    let k_4_1 = k_4_1.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_4_1.as_slice(), 64)
}
...
pub(crate) fn get_k_4_2<F: BigPrimeField>(
    ...
    let k_4_2 = k_4_2.into_iter().map(F::from).map(|v| ctx.load_constant(v)).collect::<Vec<_>>();

    limbs_le_to_bigint(ctx, range, k_4_2.as_slice(), 64)
}
