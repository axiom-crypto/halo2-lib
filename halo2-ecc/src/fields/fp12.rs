...
pub struct Fp12Chip<F: PrimeField, FpChip: PrimeFieldChip<F>, Fp12: Field, const XI_0: i64>
where
...
impl<F, FpChip, Fp12, const XI_0: i64> Fp12Chip<F, FpChip, Fp12, XI_0>
where
    F: PrimeField,
...
impl<F, FpChip, Fp12, const XI_0: i64> FieldChip<F> for Fp12Chip<F, FpChip, Fp12, XI_0>
where
    F: PrimeField,
    ...
    Fp12: Field + FieldExtConstructor<FpChip::FieldType, 12>,
{
    ...
    fn get_assigned_value(&self, x: &Self::FieldPoint) -> Value<Fp12> {
