...
There are multiple opportunities to contribute at any level. It doesn't matter if you are just getting started with Rust or ZK or are the most weathered expert, we can use your help.
...
The [discussion Telegram][dev-tg] is available for any concerns you may have that are not covered in this guide.

### Code of Conduct

The Halo2-lib project adheres to the [Rust Code of Conduct][rust-coc]. This code of conduct describes the _minimum_ behavior expected from all contributors.

Instances of violations of the Code of Conduct can be reported by contacting the team at [halo2lib@axiom.xyz
](mailto:halo2lib@axiom.xyz).
...
- **Asking in the discussion Telegram:** The [Halo2-lib Discussion Telegram][dev-tg] is a fast and easy way to ask questions.

As Halo2-lib is still in heavy development, the documentation can be a bit scattered.
The [docs][axiom-docs] and READMEs in this repo are our current best-effort attempt at keeping up-to-date information.
...
If the change being proposed alters code, it is either adding new functionality to Halo2-lib, or fixing existing, broken functionality.
In both of these cases, the pull request should include one or more tests to ensure that Halo2-lib does not regress
in the future.
...
From within GitHub, opening a new pull request will present you with a template that should be filled out. **Please make pull requests to the [community-edition](https://github.com/axiom-crypto/halo2-lib/tree/community-edition) branch.** Please try your best at filling out the details, but feel free to skip parts if you're not sure what to put.
...
**Any Halo2-lib community member is welcome to review any pull request**.
...
1. Does this change make sense for Halo2-lib?
2. Does this change make Halo2-lib better, even if only incrementally?
...
Nits (requests for small changes that are not essential) are fine, but try to avoid stalling the pull request. Most nits can typically be fixed by the Halo2-lib maintainers merging the pull request, but they can also be an opportunity for the contributor to learn a bit more about the project.
...
_Adapted from the [foundry contributing guide](https://github.com/foundry-rs/foundry/blob/master/CONTRIBUTING.md)_.

### Releasing

The Halo2-lib maintainers will make releases in a conservative manner, only using GitHub releases to mark official audited versions of the code.

[rust-coc]: https://github.com/rust-lang/rust/blob/master/CODE_OF_CONDUCT.md
[dev-tg]: https://t.me/halo2lib
[axiom-docs]: https://docs.axiom.xyz/zero-knowledge-proofs/getting-started-with-halo2
